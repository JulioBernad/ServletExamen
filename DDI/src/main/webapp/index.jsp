...
<body>
	...
	<table width="40%" align="center">
		...
		<tr>
			...
			<td><select name ="cLengua" id="cLengua">
			  	<%  
						...
						List<Languages> listAllIdiomas = servicio.listarLenguas(); 
		...
		<tr>
			<td colspan="2" align="left"><input type="button" onclick="window.location.href='Show.jsp'"  value="Mostrar Datos"></td>
		</tr>
	</table>
</form>
</body>
